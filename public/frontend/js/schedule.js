...
Vue.component('vue-pagination', __webpack_require__(52));
...
var myMixins = {
  methods: {
     ...
     * parameter status
     */
    getBackgroundColour: function getBackgroundColour(status) {
      switch (status) {
        case "new":
          return 'yellow-bg';
        case "approved":
     ...
     */
    getMovementStatus: function getMovementStatus(status, role) {
      switch (status) {
        case "new":
     ...
     * @returns {string}
     */
    getQuoteId: function getQuoteId(quoteId) {
      return 'QT#000' + quoteId;
    },


    getTotalNumberOfPalletsOnMovement: function getTotalNumberOfPalletsOnMovement(movements) {
      var sum = 0;
...
var app1 = new Vue({
  ...
  methods: {
     ...
     * parameter page, past
     */
    getPresentData: function getPresentData(page, past) {
      var self = this;
      $.ajax({
        url: url,
        data: {
...
var app2 = new Vue({
  ...
  methods: {
     ...
     * parameter page, past
     */
    getPastData: function getPastData(page, past) {
...
Component.options.__file = "/var/www/html/find_fill/resources/assets/client/js/components/Paginate.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] Paginate.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-58e460c0", Component.options)
  } else {
    hotAPI.reload("data-v-58e460c0", Component.options)
  }
})()}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-58e460c0", module.exports)
  }
}
