    ...
    <div class="row">
      <div class="col-xs-6 col-sm-6 col-md-4">
        <h1 class="page-title font-green sbold">
          <i class="fa fa-television font-green"></i> File
          <small class="font-green sbold">Categories List</small>
        </h1>
      </div>
      <div class="col-xs-6 col-sm-6 col-md-8">
        <div class="caption pull-right">
          <a href="{{ route('file.categories.create') }}" class="btn btn-sm bold green">
            <i class="fa fa-plus"></i>New Category
          </a>
          <a href="{{ route('uploaded-file.create') }}" class="btn btn-sm bold green">
...
@section('script')
  ...
  <script type="application/javascript">
    var categoryTable = $('#file-category-table').DataTable({
      ...
      stateSave: false,
      ajax: {
        url: '{!! route('file.getAllCategories') !!}'
      },
      order: [[2, 'asc']],
      columns: [
