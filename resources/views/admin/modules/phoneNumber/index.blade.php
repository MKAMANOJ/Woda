    ...
    <div class="row">
      <div class="col-xs-6 col-sm-6 col-md-4">
        <h1 class="page-title font-green sbold">
          ...
          <small class="font-green sbold">Phone Number List</small>
        </h1>
      </div>
      <div class="col-xs-6 col-sm-6 col-md-8">
        <div class="caption pull-right">
          <a href="{{ route('phone-numbers.create') }}" class="btn btn-sm bold green">
          <i class="fa fa-plus"></i>Phone Number
          </a>
        </div>
      </div>
    </div>
...
@section('script')
  ...
  <script type="application/javascript">
    var categoryTable = $('#file-category-table').DataTable({
      ...
      stateSave: false,
      ajax: {
        url: '{!! route('phone-numbers.getAllPhoneNumbers') !!}'
      },
      order: [[2, 'asc']],
      columns: [
