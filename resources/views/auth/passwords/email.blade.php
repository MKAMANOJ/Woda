...
@section('content')
  <form class="form-horizontal" role="form" method="POST"
        action="{{ request()->segment(1) == 'client' ? route('client.password.email') : route('password.email') }}">
    {{ csrf_field() }}
    ...
    <div class="form-group">
      <div class="form-actions">
        <a href="{{ (request()->segment(1) == 'administrator') ?route('admin.index') : route('client.showLoginForm') }}"
